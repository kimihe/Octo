...
class VGG_11:
    """VGG11: 8 CONVs + 3 Affines
        ...
        conv1   - (compensation1 - batchnorm1) - relu_of_conv_1
        conv2   - (compensation2 - batchnorm2) - relu_of_conv_2
        conv3   - (compensation3 - batchnorm3) - relu_of_conv_3
        conv4   - (compensation4 - batchnorm4) - relu_of_conv_4  - pool1
        conv5   - (compensation5 - batchnorm5) - relu_of_conv_5
        conv6   - (compensation6 - batchnorm6) - relu_of_conv_6
        conv7   - (compensation7 - batchnorm7) - relu_of_conv_7
        conv8   - (compensation8 - batchnorm8) - relu_of_conv_8
    ...
    def __init__(self, input_dim=(3, 32, 32),  # CIFAR-10
        ...
        self.conv_param_list = [conv_param_1, conv_param_2, conv_param_3, conv_param_4,
                                conv_param_5, conv_param_6, conv_param_7, conv_param_8]
        ...
        # Affine layers
        pre_node_nums[8] = pre_channel_num * 4 * 4  # pool_output_size = int(filter_num * (conv_output_size/2) * (conv_output_size/2))
        pre_node_nums[9] = hidden_size_1
        pre_node_nums[10] = hidden_size_2
        ...
        self.params['Affine_W_1'] = wight_init_scales[8] * np.random.randn(pre_channel_num * 4 * 4, hidden_size_1)
        self.params['Affine_b_1'] = np.zeros(hidden_size_1)
        self.params['Affine_W_2'] = wight_init_scales[9] * np.random.randn(hidden_size_1, hidden_size_2)
        self.params['Affine_b_2'] = np.zeros(hidden_size_2)
        self.params['Affine_W_3'] = wight_init_scales[10] * np.random.randn(hidden_size_2, output_size)
        self.params['Affine_b_3'] = np.zeros(output_size)

        # 4. Init parameters of Compensation and BatchNorm layers =================================
        compensation_param_shape_list = [(self.mini_batch_size, 64, 30, 30), (self.mini_batch_size, 128, 28, 28),
                                         (self.mini_batch_size, 256, 26, 26), (self.mini_batch_size, 256, 24, 24),
                                         (self.mini_batch_size, 512, 10, 10), (self.mini_batch_size, 512, 8, 8),
                                         (self.mini_batch_size, 512, 6, 6), (self.mini_batch_size, 512, 4, 4)]
        # batchnorm_param_shape_list = [(100, 57600), (100, 100352), (100, 173056), (100, 147456), (100, 51200), (100, 32768), (100, 18432), (100, 8192)]
