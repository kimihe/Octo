...
class VGG_11:
    ...
    def __init__(self, input_dim=(1, 28, 28),  # MNIST
        ...
        # Affine layers
        pre_node_nums[8] = pre_channel_num * 2 * 2  # pool_output_size = int(filter_num * (conv_output_size/2) * (conv_output_size/2))
        ...
        self.params['Affine_W_1'] = wight_init_scales[8] * np.random.randn(pre_channel_num * 2 * 2, hidden_size_1)
        ...
        compensation_param_shape_list = [(self.mini_batch_size, 64, 26, 26), (self.mini_batch_size, 128, 24, 24),
                                         (self.mini_batch_size, 256, 22, 22), (self.mini_batch_size, 256, 20, 20),
                                         (self.mini_batch_size, 512, 8, 8), (self.mini_batch_size, 512, 6, 6),
                                         (self.mini_batch_size, 512, 4, 4), (self.mini_batch_size, 512, 2, 2)]
        # batchnorm_param_shape_list = [(100, 43264), (100, 73728), (100, 123904), (100, 102400), (100, 32768), (100, 18432), (100, 8192), (100, 2048)]
