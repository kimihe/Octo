...
class Alexnet:
    ...
    def __init__(self, input_dim=(3, 32, 32),  # CIFAR-10
                 ...
                 conv_param_2={'filter_num': 192, 'filter_size': 3, 'pad': 1, 'stride': 1,
                               'enable_fp_qat': False, 'enable_bp_gradient_quantization': False,
                               'qat_scheme': KMQATScheme.FullPrecision},
        ...
        # Affine layers
        pre_node_nums[5] = pre_channel_num * 4 * 4  # pool_output_size = int(filter_num * (conv_output_size/2) * (conv_output_size/2))
        ...
        self.params['Affine_W_1'] = wight_init_scales[5] * np.random.randn(pre_channel_num * 4 * 4, hidden_size_1)
        ...
        compensation_param_shape_list = [(self.mini_batch_size, 64, 32, 32), (self.mini_batch_size, 192, 16, 16),
                                         (self.mini_batch_size, 384, 8, 8), (self.mini_batch_size, 256, 8, 8),
                                         (self.mini_batch_size, 256, 8, 8)]
        # batchnorm_param_shape_list = [(100, 65536), (100, 49152), (100, 24576), (100, 16384), (100, 16384)]
