...
from alexnet_lac.alexnet_cifar10 import Alexnet
from common.trainer import Trainer
from quantizer.KMQATScheme import KMQATScheme

(x_train, t_train), (x_test, t_test) = load_cifar10(flatten=False)  # CIFAR-10

# ======================================= Training Configuration =======================================
train_data_num = 500  # max: 50000 of cifar10, 60000 of mnist
...
training_experiment_name = 'alexnet_lac_cifar10'  # do not change
...
network = Alexnet(input_dim=(3, 32, 32),
