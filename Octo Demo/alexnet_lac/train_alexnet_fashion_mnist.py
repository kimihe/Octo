...
import pandas as pd
from dataset.FashionMnist import load_FashionMnist
from alexnet_lac.alexnet_fashion_mnist import Alexnet
from common.trainer import Trainer
from quantizer.KMQATScheme import KMQATScheme

(x_train, t_train), (x_test, t_test) = load_FashionMnist(flatten=False)  # Fashion MNIST

# ======================================= Training Configuration =======================================
train_data_num = 600  # max: 50000 of cifar10, 60000 of mnist
...
training_experiment_name = 'alexnet_lac_fashion_mnist'  # do not change
...
# AlexNet: 5 CONVs + 2 FCs
network = Alexnet(input_dim=(1, 28, 28),
